 ...
 */
final class Version20241013221026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dette_entity (id INT NOT NULL, date DATE NOT NULL, montant INT NOT NULL, montant_verse INT DEFAULT NULL, montant_restant INT DEFAULT NULL, create_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, update_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN dette_entity.date IS \'(DC2Type:date_immutable)\'');
        $this->addSql('COMMENT ON COLUMN dette_entity.create_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN dette_entity.update_at IS \'(DC2Type:datetime_immutable)\'');
